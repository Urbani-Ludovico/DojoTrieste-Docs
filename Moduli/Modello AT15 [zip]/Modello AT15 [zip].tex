...
\fancyhf{}
\chead{%
	\includegraphics[height = 0.5in]{logo_fijlkam_h.png}%
}
...
\titlespacing*{\section}{0pt}{0.1in}{0.05in}

\subsectionfont{\fontsize{9}{10}\selectfont}
\renewcommand{\thesubsection}{\Alph{subsection}.}
\titlespacing*{\subsection}{0pt}{0.1in}{0.05in}

\newcommand{\field}[1]{\underline{\hspace{#1}\rule{0pt}{4ex}}}
\newcommand{\fieldfill}{\hrulefill\rule{0pt}{3ex}}
